...
class validarEn(webapp2.RequestHandler):
    def post(self):
        ...
        if user is not None:
            self.response.out.write(ENG_HTML)
            self.response.out.write("<br></br><h1><font color='red'>A username with that name already exists</font></h1>")
            return None
...
class validarEus(webapp2.RequestHandler):
    def post(self):
        ...
        if user is not None:
            self.response.out.write(EUS_HTML)
            self.response.out.write("<br></br><h1><font color='red'>Sartutako erabiltzaile izena hartuta dago</font></h1>")
            return None
